...
## Solution
Going to `/bytes`, shows a large array of numbers.</br>
With the following script, we can reconstruct the image:</br>
```
Credits to Dvd848 as I needed help with this
...
```
This generates a QR-code.</br>
Copy the image link and paste the URL in `xzing.org` to get the meaning of the QR-code and will show the flag.
